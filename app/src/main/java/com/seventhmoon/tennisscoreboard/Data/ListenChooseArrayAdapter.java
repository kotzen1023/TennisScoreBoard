        ...
        if (listenChooseItem != null) {
            ...
            switch (position) {
                case 0: //uk man
                    ...
                    holder.filename.setText(context.getResources().getString(R.string.voice_gbr_man));
                    break;
                case 1: //uk woman
                    bitmap = BitmapFactory.decodeResource(view.getResources(), R.drawable.uk_flag);
                    holder.filename.setText(context.getResources().getString(R.string.voice_gbr_woman));
                    break;
                case 2: //user

...
public class GameActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (set == null && games == null && tiebreak == null && deuce == null) {
            stack.clear();
            if (check_file_exist(filename)) {
                ...
                if (info.length > 1) {
                    ...
                    try {
                        if (info[2].length() > 1) { //true or false
                            boolean ret = Boolean.valueOf(info[2]);
                            if (!ret) { //tiebreak
                                tiebreak = "1";
                            }
                        } else if (info[2].length() == 1) {
                            int ret = Integer.valueOf(info[2]);
                            if (ret == 1) { //deciding game
                                tiebreak = "1";
                            } else if (ret == 2) {
                    ...
                    if (info.length > 8) {
                        try {
                            is_In_SuperTiebreak = Boolean.valueOf(info[8]);
                ...
                if (msg.length > 1) {
                    ...
                    for (String s : stat) {
                        ...
                        try {
                            ...
                            if (data.length > 75) {
                                new_state.setForehandLobUp(Short.valueOf(data[75]));
                                new_state.setForehandLobDown(Short.valueOf(data[76]));
                                new_state.setBackhandLobUp(Short.valueOf(data[77]));
                            ...
                            public void onClick(DialogInterface dialog, int item) { //pick from gamer
                                if (is_second_serve) { //in second serve
                                    ...
                                    if (item == 0) { //ace
                                        ...
                                        second_serve_won = 1;
                                        calculateScore(YOU_SCORE);
                                    } else if (item == 8) { //forehand lob
                                        forehand_lob_count = 1;
                                        second_serve_won = 1;
                                        calculateScore(YOU_SCORE);
                                    } else if (item == 9) { //backhand lob
                            ...
                            public void onClick(DialogInterface dialog, int item) {
                                if (is_second_serve) {
                                    ...
                                    if (item == 0) { //unforced error
                                        ...
                                        second_serve_lost = 1;
                                        calculateScore(YOU_SCORE);
                                    } else if (item == 6) { //forehand lob
                                        forehand_lob_count = 1;
                                        second_serve_lost = 1;
                                        calculateScore(YOU_SCORE);
                                    } else if (item == 7) { //backhand lob
                                        backhand_lob_count = 1;
                                        second_serve_lost = 1;
                                        calculateScore(YOU_SCORE);
                ...
                switch (action) {
                    case YOU_RETIRE:
                        ...
                        if (stack.isEmpty()) { //the state stack is empty
                            ...
                            new_state.setForehandLobUp(current_state.getForehandLobUp());
        ...
        if (tiebreak.equals("0") || tiebreak.equals("2") || tiebreak.equals("3")) { //use tiebreak or super tiebreak or long game
            ...
            if (games.equals("0")) { //6 game in a set
                ...
                if (is_In_SuperTiebreak) {
                    Log.d(TAG, "[In SuperTiebreak start]");
                    if (new_state.getSet_game_up(current_set) == 1 &&
                            new_state.getSet_game_down(current_set) == 0) {
                        setsWinUp++;
                        ...
                        if (voiceOn) {
                            ...
                            new_state.getSet_game_down(current_set) == 1) { // 0:1 => you win this set
                        //set sets win
                        setsWinDown++;
            ...
            Log.d(TAG, "[Use deciding game start]");
            if (games.equals("0")) { //6 game in a set
                Log.d(TAG, "[6 game in a set start]");
            ...
            Log.d(TAG, "[Use deciding game end]");
        }
    ...
    private static int getCurrentSetVoice(int current_set) {
        int call = 0 ;

        switch (current_voice_type) {
            case GBR_MAN:
                if (current_set == 1) {
                    call = R.raw.gbr_man_first_set;
                } else if (current_set == 2) {
                    call = R.raw.gbr_man_second_set;
                } else if (current_set == 3) {
                    call = R.raw.gbr_man_third_set;
                } else if (current_set == 4) {
                    call = R.raw.gbr_man_forth_set;
                }
                break;
            case GBR_WOMAN:
